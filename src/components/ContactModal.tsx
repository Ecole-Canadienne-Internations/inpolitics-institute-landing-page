        ...
        <DialogContent className="bg-white sm:max-w-lg border-0 shadow-2xl">
          <DialogHeader>
            ...
            <DialogDescription className="text-muted-foreground">
              Présentez-nous votre projet, votre fonction et vos objectifs. Notre équipe vous répond
              sous 48h.
            </DialogDescription>
          </DialogHeader>
    ...
    <form onSubmit={onSubmit} className="grid gap-4 mt-2">
      <div className="grid sm:grid-cols-2 gap-4">
        <input
          ...
          maxLength={100}
          placeholder="Prénom"
          className="h-11 px-4 rounded-lg border border-border bg-white focus:outline-none focus:ring-2 focus:ring-crimson/40"
        />
        <input
          name="last_name"
          required
      ...
      <textarea
        ...
        className="px-4 py-3 rounded-lg border border-border bg-white focus:outline-none focus:ring-2 focus:ring-crimson/40"
      />
      <button
        type="submit"
        disabled={sending}
