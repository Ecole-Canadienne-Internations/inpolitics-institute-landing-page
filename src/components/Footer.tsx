      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10 py-16 grid md:grid-cols-12 gap-10">
        <div className="md:col-span-5">
          ...
          <p className="mt-6 text-sm leading-relaxed max-w-sm">
            L'Institut des Décideurs Publics, de la Diplomatie, de la Performance Territoriale et de
            la Gouvernance Digitale. Sites Europe à Gigean (Montpellier Métropole) & Afrique.
          </p>
          <div className="mt-7 space-y-3 text-sm">
            ...
            <div className="flex items-start gap-3">
              ...
              <a href="tel:+33746440427" className="hover:text-white transition">
                +33 7 46 44 04 27
              </a>
            </div>
            <div className="flex items-start gap-3">
