  ...
  return (
    <div className="min-h-screen bg-white text-foreground">
      ...
      <main className="pt-32 md:pt-40 pb-24">
        ...
        <article className="max-w-4xl mx-auto px-6 lg:px-10 mt-12">
          <Link
            to="/"
            ...
            <div className="flex bg-muted rounded-full p-0.5">
              <button
                ...
                className={`px-5 py-1.5 text-xs font-semibold rounded-full transition-colors ${
                  lang === "en" ? "bg-crimson text-white" : "text-muted-foreground hover:text-foreground"
                }`}
              >
                English
              </button>
              <button
                onClick={() => setLang("fr")}
                className={`px-5 py-1.5 text-xs font-semibold rounded-full transition-colors ${
                  lang === "fr" ? "bg-crimson text-white" : "text-muted-foreground hover:text-foreground"
                }`}
              >
                Français
              </button>
