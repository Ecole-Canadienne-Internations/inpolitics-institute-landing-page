...
export const Route = createFileRoute("/biographie/dieudonne-toukea")({
  ...
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Biographie du Dr Dieudonné TOUKEA, Directeur Afrique d'InPolitics Institute.",
      },
          ...
          <div className="grid md:grid-cols-12 gap-12 items-start">
            <div className="md:col-span-7 order-2 md:order-1">
              ...
              <p className="mt-6 text-lg md:text-xl text-muted-foreground leading-relaxed">
                Directeur Afrique d'Inpolitics Institute. Docteur en Études Internationales,
                enseignant-chercheur et consultant en gestion de projet.
              </p>
