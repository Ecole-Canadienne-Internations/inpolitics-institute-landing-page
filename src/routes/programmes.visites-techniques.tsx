  ...
  head: () => ({
    meta: [
      { title: "Visites Techniques — InPolitics Institute" },
      {
        name: "description",
        content:
          "Smart Cities, eau, déchets, mobilités, énergie : immersions opérationnelles pour décideurs.",
      },
      ...
      {
        property: "og:url",
        content: "https://inpoliticsinstitute.com/programmes/visites-techniques",
      },
      { property: "og:type", content: "article" },
    ],
    links: [
      { rel: "canonical", href: "https://inpoliticsinstitute.com/programmes/visites-techniques" },
    ],
  }),
});
