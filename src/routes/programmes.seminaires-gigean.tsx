  ...
  head: () => ({
    meta: [
      { title: "Séminaires d'Immersion à Gigean — InPolitics Institute" },
      {
        name: "description",
        content:
          "Formations courtes et intensives de 3 à 5 jours pour l'élite publique et privée sur le site Europe.",
      },
      ...
      {
        property: "og:url",
        content: "https://inpoliticsinstitute.com/programmes/seminaires-gigean",
      },
      { property: "og:type", content: "article" },
    ],
    links: [
      { rel: "canonical", href: "https://inpoliticsinstitute.com/programmes/seminaires-gigean" },
    ],
  }),
});
