...
export const Route = createFileRoute("/biographie/antoine-obtel")({
  ...
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Biographie d'Antoine OBTEL, Directeur Associé d'InPolitics Institute.",
      },
          ...
          <div className="grid md:grid-cols-12 gap-12 items-start">
            <div className="md:col-span-7 order-2 md:order-1">
              ...
              <p className="mt-6 text-lg md:text-xl text-muted-foreground leading-relaxed">
                Directeur Associé. Chercheur en Histoire et Relations Internationales. Réserviste du
                Quai d'Orsay.
              </p>
