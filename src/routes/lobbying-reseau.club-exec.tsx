...
export const Route = createFileRoute("/lobbying-reseau/club-exec")({
  ...
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Cercle de réflexion privé réservé aux dirigeants, élus et hauts fonctionnaires.",
      },
    ...
    links: [
      { rel: "canonical", href: "https://inpoliticsinstitute.com/lobbying-reseau/club-exec" },
    ],
  }),
});
