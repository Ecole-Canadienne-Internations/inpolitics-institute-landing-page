...
export const Route = createFileRoute("/diaspora/programme-landing")({
  ...
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Bootcamp d'immersion de 5 jours à Gigean pour les talents de la diaspora.",
      },
    ...
    links: [
      { rel: "canonical", href: "https://inpoliticsinstitute.com/diaspora/programme-landing" },
    ],
  }),
});
